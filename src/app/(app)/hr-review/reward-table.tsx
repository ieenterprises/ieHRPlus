...
import { PlusCircle, Loader2, CheckCircle, Trash2, Download, Search, Calendar as CalendarIcon, Upload, Folder } from "lucide-react";
...
import { type Reward, type Attachment } from "@/lib/types";
                                        ...
                                        <Popover>
                                            ...
                                            <PopoverContent className="w-auto p-0">
                                                <div className="flex flex-col">
                                                    <Label htmlFor="file-upload-reward" className="flex items-center gap-2 p-2 hover:bg-accent cursor-pointer rounded-t-md">
                                                        <Upload className="h-4 w-4" /> Upload from Computer
                                                    </Label>
                                                    <Input id="file-upload-reward" type="file" multiple className="hidden" onChange={handleFileChange} />
