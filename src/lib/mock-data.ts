...
const MOCK_PRODUCTS = [
  // Food
  { id: uid("prod"), name: "Classic Burger", price: 12.99, stock: 50, category_id: "cat_food", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  { id: uid("prod"), name: "Margherita Pizza", price: 15.50, stock: 30, category_id: "cat_food", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  { id: uid("prod"), name: "Chicken Caesar Salad", price: 10.25, stock: 40, category_id: "cat_food", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  // Beverages
  { id: uid("prod"), name: "Coca-Cola", price: 2.50, stock: 100, category_id: "cat_beverages", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  { id: uid("prod"), name: "Fresh Orange Juice", price: 4.00, stock: 60, category_id: "cat_beverages", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  // Snacks
  { id: uid("prod"), name: "French Fries", price: 4.50, stock: 80, category_id: "cat_snacks", image_url: "https://placehold.co/300x200.png", status: 'Available' },
  // Rooms
...
const MOCK_PRINTERS = [
    { id: uid("printer"), name: "Kitchen Printer", connection_type: "Network", ip_address: "192.168.1.100", pos_device_id: "pos_front" },
...
const generateDynamicMockData = (ownerId: string, businessName: string) => {
  ...
  const sales = [
    // Sale 1: Recent cash sale
    {
      ...
      items: [{ id: MOCK_PRODUCTS[0].id, name: MOCK_PRODUCTS[0].name, quantity: 1, price: 12.99 }, { id: MOCK_PRODUCTS[3].id, name: MOCK_PRODUCTS[3].name, quantity: 1, price: 2.50 }],
      status: "Fulfilled",
    ...
    // Sale 2: Credit sale for John Doe
    {
      ...
      items: [{ id: MOCK_PRODUCTS[1].id, name: MOCK_PRODUCTS[1].name, quantity: 1, price: 15.50 }],
      status: "Fulfilled",
  ...
  return { sales, debts, reservations, settings };
};
...
export const seedDatabaseWithMockData = (batch: WriteBatch, ownerId: string, businessName: string) => {
  ...
  const { sales, debts, reservations, settings } = generateDynamicMockData(ownerId, businessName);
